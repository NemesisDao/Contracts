...
contract sNMS is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Nemesis", "sNMS", 9) ERC20Permit() {
    ...
    /**
        @notice increases sNMS supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sNMS
